PROMPTS = {
    ...
    'ngo_router': "You are given a briefing on the humanitarian situation and a list of resources needed. Along with the briefing you were given, output a list of relevant NGOs for the given humanitarian situation.\
                The NGOs should be operating within the region of interest and have applicable aid for the type of disaster. You must output the briefing and NGO list in the output format given to you in the tools. That is, a title, briefing body, and ngo_list.\
